// This program accepts connection from multiple client and allows them communicate through the server.
...
int main(void)
{
    ...
    while (1)
    {
        ...
        threadID = pthread_create(&client_thread, NULL, (void *) &clientHandler, client_args);
        if (threadID != 0)
        {
